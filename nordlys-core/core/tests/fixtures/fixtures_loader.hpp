...
public:
  static std::vector<std::vector<float>> generate_embeddings(size_t n,
                                                              size_t dim,
                                                              unsigned seed = 42) {
  ...
  generate_clustered_embeddings(size_t n, size_t dim, size_t n_clusters, unsigned seed = 42) {
    std::mt19937 rng(seed);
  ...
  static std::vector<std::vector<double>> generate_embeddings_double(size_t n,
                                                                      size_t dim,
                                                                      unsigned seed = 42) {
    std::mt19937 rng(seed);
